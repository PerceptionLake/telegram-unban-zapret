...
# <img src="https://cdn-icons-png.flaticon.com/128/5968/5968756.png" height=28 /> <a href="https://github.com/PerceptionLake/telegram-unban-zapret">PerceptionLake/telegram-unban-zapret</a> <img src="https://cdn-icons-png.flaticon.com/128/1384/1384060.png" height=28 />

**Discord · YouTube · Telegram** — работает, когда «Connecting…» и тормоза  

Скачать актуальную сборку в [**Releases → DiscordFix**](https://github.com/PerceptionLake/telegram-unban-zapret/releases/tag/DiscordFix)
...
[Инструкция по установке и частые вопросы](https://perceptionlake.github.io/telegram-unban-zapret/)
...
> Если вы наткнулись на что-то вне репозитория `PerceptionLake/telegram-unban-zapret`, что распространяется от моего лица - **ФЕЙК**.
...
2. Скачайте архив (zip/rar) со [страницы релиза DiscordFix](https://github.com/PerceptionLake/telegram-unban-zapret/releases/tag/DiscordFix)
...
Если этого не произошло, то см. [#522](https://github.com/PerceptionLake/telegram-unban-zapret/issues/522)
...
- См. [#765](https://github.com/PerceptionLake/telegram-unban-zapret/issues/765)
...
- Скачайте последнюю версию [со страницы релизов](https://github.com/PerceptionLake/telegram-unban-zapret/releases/tag/DiscordFix) (`zapret-discord-youtube-DiscordFix.rar` / `zapret-discord-youtube-DiscordFix.zip`)
...
- См. также [#251](https://github.com/PerceptionLake/telegram-unban-zapret/discussions/251)
...
- См. также [#252](https://github.com/PerceptionLake/telegram-unban-zapret/discussions/252)
...
Если и это не помогло, создайте ветку обсуждений в разделе [Discussions](https://github.com/PerceptionLake/telegram-unban-zapret/discussions) (не в issues) и ждите помощи от других игроков.

### Не нашли своей проблемы

- Создайте её [тут](https://github.com/PerceptionLake/telegram-unban-zapret/issues)
...
Проект распространяется на условиях лицензии [MIT](https://github.com/PerceptionLake/telegram-unban-zapret/blob/main/LICENSE.txt)
